  ...
  <div id="hud">
    ...
    <div class="panel" id="help">
      ...
      <ul>
        ...
        <li><b>验收 #44</b>：楼梯能平滑走上去（不弹跳）；3 米高台跳不上去；斜撞墙会沿墙滑</li>
        <li><b>验收 #45</b>：空中按住方向画圈，速度不会越来越快</li>
        <li><b>验收 #47</b>：角色颜色代表动作状态，缓慢加速时不应在两色之间闪烁</li>
        <li><b>13.2</b>：按 F1 看粉色线框 —— 所有职业共用的战斗碰撞体，视觉大小不影响它</li>
        <li><b>6.4</b>：F1 下的绿色线框 = 挡移动但<b>不挡视线</b>（楼梯、低栏杆）</li>
      </ul>
    </div>
  </div>
`;
