    ...
    effects: [
      {
        ...
        aura: {
           ...
           * ★ P11 保命轮：400→500。900 血是全场最低，500 点吸收 ≈ 55% 最大生命，
           *   这才够上审计判据的「扛住 3 秒集火」——「等效吸收盾」那一档。
           *   冰封庇护（immuneAll / CD 90）已经是法师的真保命键，
           *   所以这里只补**冷却期间**的那段空窗，不新增技能。
           * ⚠️ 同时修掉一处文档说谎：这段 description 从 M14 起就一直写着
           *   「吸收 220 点」，而实际值早已是 400 —— UI 照着念了整整两个阶段。
           */
          absorb: 500,
          description: '吸收 500 点伤害，持续 8 秒。',
        },
      },
    ],
    description: '获得持续 8 秒、吸收 500 点伤害的护盾。',
  },
  {
